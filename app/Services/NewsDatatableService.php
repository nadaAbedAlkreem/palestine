    ...
    public function handle( $request,$data)
    {
             return DataTables::of($data)
                     ...
                     ->addColumn('action', function ($data)
                      {
                        ...
                        if (auth()->user()->can("delete news")) {
                         $buttons .=  '<button name="bstable-actions" class="deleteRecord btn btn-xs btn show_confirm"    data-id="'.$data->id.'" > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
               ...
               ' ;
                    ...
                    ->rawColumns([ 'action'  , 'title' , 'title_ar'  , 'description_ar', 'description'])
                    ->make(true); 
