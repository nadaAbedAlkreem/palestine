...
<div class="containerr">
        <section class="hedsid" >
            <h6><a href="{{route('web.home')}}">{{__('dashboard.home')}} / </a></h6><h6>{{__('columns.programs')}}    </h6>
        </section>
                    ...
                    <div class="allcardpro">
                            ...
                            @if($CurrentLang == "ar")      
                              ...
                              <div class="cardpro" >
                                ...
                                <h4 > 
                                          <a href="{{route('programs.details' ,['id' => $programs->id])}}">
                                          <h6>{{$programs->title_ar}}</h6></a> </h4>
                                          <p >{{$programs->brief_ar}}
                                          </p>
                              </div>
                              @endforeach  
