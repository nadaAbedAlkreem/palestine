...
@section('content')
	...
	<body id="kt_body">
						...
						<div class="container-fluid" id="kt_content_container">
							...
							<div class="card card-flush">
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-contact" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        
											<th class="min-w-100px">{{__('columns.full_name')}}</th>
											<th class="min-w-100px">{{__('columns.email')}}</th>
											<th class="min-w-100px">{{__('columns.message')}}</th>
		...
		<script src="{{url('assets/js/custom/actions/contact-actions.js')}}"></script>
