							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="">
										...
										<a href="{{route('slider.create')}}"       class="btn btn-primary">{{__('button.AddSlider')}}</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-silder" id="kt_ecommerce_products_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-100px">{{__('columns.rediract_to')}}    </th>
												<th class="min-w-100px">{{__('columns.text_button')}}    </th>
												<th class="min-w-100px">{{__('columns.news')}}</th>
												<th class="min-w-100px">{{__('columns.active')}}    </th>
												<th class="min-w-100px">{{__('columns.publication_start')}}   </th>
												<th class="min-w-100px">{{__('columns.publication_end')}}    </th>
